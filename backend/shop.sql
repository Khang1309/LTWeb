...
CREATE TABLE orders (
    ...
    --total_amount DECIMAL(12,2) NOT NULL DEFAULT 0, cai nay tinh toan duoc nen khoi bo
...
('Nguyen Van Admin',  'admin1@store.com', 'hashed_admin_1', 'admin',    '0901000001'),
('Tran Thi Manager',  'admin2@store.com', 'hashed_admin_2', 'admin',    '0901000002'),
('Le Hoang Supervisor','admin3@store.com','hashed_admin_3', 'admin',    '0901000003'),
('Le Minh Customer',  'customer1@gmail.com','hashed_customer_1','customer','0912000001'),
('Pham Ngoc Lan',     'customer2@gmail.com','hashed_customer_2','customer','0912000002'),
('Hoang Gia Bao',     'customer3@gmail.com','hashed_customer_3','customer','0912000003'),
('Nguyen Thu Ha',     'customer4@gmail.com','hashed_customer_4','customer','0912000004'),
('Tran Quoc Viet',    'customer5@gmail.com','hashed_customer_5','customer','0912000005'),
('Do Minh Anh',       'customer6@gmail.com','hashed_customer_6','customer','0912000006');
-- =========================
-- ADMINS
-- =========================
